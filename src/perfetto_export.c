...
/* Strings are searchable in Perfetto without duplicate debug fields. */
				   ...
				   const char *name, u64 value)
{
	...
	native_annotation_string(event, name, text);
}
...
{
	native_annotation_string(event, name, value ? "true" : "false");
}
